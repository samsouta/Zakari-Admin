...
export type GameProductFormData = {
  service_id: number;
  slug: string;
  name: string;
  logo_url: string;
...
export const AddGameProductModal: React.FC<AddGameProductModalProps> = ({ 
  error, 
  isLoading, 
  isOpen, 
  onClose, 
      ...
      <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4">
        <Dialog.Panel className="mx-auto w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] rounded-lg bg-white dark:bg-gray-900 shadow-xl overflow-hidden flex flex-col">
          ...
          <div className="flex justify-between items-center p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
            <Dialog.Title className="text-lg sm:text-xl font-semibold">Add Game Product</Dialog.Title>
            <button
              onClick={onClose}
